...
const ProductDetails = ({productInd, products}) => {
    const {image, name, details, price} = productInd;
        ...
        <div>
            <div className="product-detail-container">
                ...
                <div className="product-detail-desc">
                    <h1>{name}</h1>
                    <p className="price">R${price.toFixed(2).toString().replace('.', ',')}</p>
                    ...
                    <div className="buttons">
                        <button type="button" className="add-to-cart" onClick={() => onAddItem(productInd, qty, sizeJer)}>Add to Cart</button>
